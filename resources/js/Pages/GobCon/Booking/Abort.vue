	...
	>
		...
		<main class="py-8 px-2 grow shrink basis-auto max-w-screen-2xl mx-auto">
			<MazIcon
				name="x-circle"
				path="/storage/icons"
				class="h-72 w-72 text-red-700 dark:text-red-600 mx-auto"
			/>
			<h1
				class="text-5xl text-center text-red-700 dark:text-red-600 font-semibold"
			>
				{{ $t("Order Cancelled") }}
			</h1>
			<p class="text-center mt-3">
				{{
					$t(
						"Your order has been aborted. This may be due to an error, or because you have not completed the order.",
					)
				}}
			</p>
			<p class="text-center">
				{{
					$t(
						"If you think that this is an error, please contact us at info@garfaludica.it.",
					)
				}}
			</p>
			<Link
