	...
	>
		...
		<main class="py-8 px-2 grow shrink basis-auto max-w-screen-2xl mx-auto">
			<MazIcon
				name="check-circle"
				path="/storage/icons"
				class="h-72 w-72 text-green-500 dark:text-green-400 mx-auto"
			/>
			<h1
				class="text-5xl text-center text-green-500 dark:text-green-400 font-semibold"
			>
				{{ $t("Order Confirmed!") }}
			</h1>
			...
			<p class="text-center">
				{{ $t("You should receive a confirmation email shortly.") }}
			</p>
			<p class="text-center">
				{{
					$t(
						"If you don't receive the email, please reach us at info@garfaludica.it.",
					)
				}}
			</p>
