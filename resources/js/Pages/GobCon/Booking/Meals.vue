	...
	<MazCard block>
		...
		<template #content>
			<p class="mt-3">
				{{
					$t(
						"Select the meals you want to book for the event. All lunches and dinners are served by the Panoramic Hotel. The breakfasts are served by the hotels where you will stay.",
					)
				}}
			</p>
			<p class="mt-2">
